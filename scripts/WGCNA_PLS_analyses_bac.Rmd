...
p_nox_bac %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/bac_nox.tiff", compression = "lzw", height = 7.01, width = 13.3)
...
p_nh4 %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/bac_nh4.tiff", compression = "lzw", height = 7.01, width = 13.3)
...
nox %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/nox_all.tiff", compression = "lzw", height = 9, width = 19.33)

nh4_po4 <- p_nh4 + p_po4 + plot_annotation(tag_levels = 'A')
nh4_po4 %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/nh4_po4 _all.tiff", compression = "lzw", height = 9, width = 19.33)
