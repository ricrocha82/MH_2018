...
p_nox %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/euk_nox.tiff", compression = "lzw", height = 7.01, width = 13.3)
...
p_po4 %>% ggsave(filename = "~R/git_hub/MH_2018/output/plots/figures/euk_po4.tiff", compression = "lzw", height = 7.01, width = 13.3)
```
